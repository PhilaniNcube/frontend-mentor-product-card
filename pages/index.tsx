    ...
    >
      ...
      <div className="max-w-[300px] md:max-w-xl mx-auto rounded-xl overflow-hidden shadow-xl shadow-orange-200/30 grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="w-full bg-white p-6">
          ...
          <div className="flex space-x-5 items-center"><p className="text-green-800 text-3xl font-extrabold">$149.99</p><p className="text-sm text-gray-500 line-through">$169.99</p></div>

          <button className="w-full flex space-x-3 justify-center items-center py-3 mt-6 rounded-lg bg-green-700 hover:bg-green-900 text-white"><img src="../images/icon-cart.svg" className="h-6 w-6" alt="icon" /><span className="text-white font-medium">Add To Cart</span></button>
